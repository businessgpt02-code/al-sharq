      ...
      <section className="relative h-screen flex flex-col justify-center overflow-hidden pt-20 px-6 md:px-12">
        ...
        >
          ...
          >
            <Link
              to="/portfolio"
              className={`px-8 py-4 bg-white text-brand-navy font-bold rounded-full hover:bg-brand-silver transition-colors flex items-center gap-2 ${disabledActionClassName}`}
              {...disabledActionProps}
            >
