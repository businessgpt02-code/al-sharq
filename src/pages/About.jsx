  ...
  return (
    <div ref={containerRef} className="w-full">
      ...
      <section
        ...
        aria-label="Company History Timeline — Saqr Al Sharq Advertising"
      >
        {/* Ambient glows */}
        <div className="absolute inset-0 pointer-events-none -z-10">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-brand-accent/5 rounded-full blur-[180px]" />
        ...
        <div className="px-6 md:px-12">
          ...
          <motion.h2
            ...
            className="text-5xl md:text-7xl font-display font-black tracking-tighter text-white mb-14"
          >
            A DECADE OF{" "}
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              style={{ originY: 0 }}
              className="hidden md:block absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-brand-accent via-brand-accent/40 to-transparent"
            />
            {/* Mobile line */}
            <motion.div
              initial={{ scaleY: 0 }}
              ...
              transition={{ duration: 1.8, ease: [0.16, 1, 0.3, 1] }}
              style={{ originY: 0 }}
              className="md:hidden absolute left-6 top-0 bottom-0 w-[2px] bg-gradient-to-b from-brand-accent via-brand-accent/40 to-transparent"
            />
            ...
            {[
              {
                ...
                sub: "Sharjah, UAE",
                body: "Saqr Al Sharq Advertising LLC was established in Sharjah with a singular vision: to redefine advertising quality across the UAE. Our founding team set the benchmark for reliability and creative excellence from day one.",
                side: "left",
                color: "from-brand-accent to-amber-400",
              ...
              },
              {
                ...
                sub: "Dubai Expansion",
                body: "Within two years, we secured landmark contracts across Dubai — delivering bespoke illuminated signboards, 3D letter installations, and large-format digital printing for premium retail brands.",
                side: "right",
              ...
              },
              {
                ...
                sub: "Advanced Machinery",
                body: "We invested heavily in state-of-the-art production technology — CNC routing, laser engravers, and large-format UV printers — enabling us to take on higher volumes without sacrificing a single millimetre of quality.",
                side: "left",
                color: "from-emerald-400 to-brand-accent",
                glow: "bg-emerald-400",
              },
              {
                year: "2021",
                title: "Full-Service Powerhouse",
                sub: "Exhibitions & Kiosks",
                body: "Our portfolio expanded to encompass exhibition stand fabrication, bespoke mall kiosk builds, and vehicle graphics & wrapping — becoming a true 360° advertising partner for enterprise clients across all seven Emirates.",
                side: "right",
              ...
              },
              {
                ...
                sub: "UAE & Beyond",
                body: "A decade in, we stand as one of the UAE's most trusted advertising fabricators — with a 100% on-time delivery record, a portfolio spanning 500+ projects, and a team of specialists committed to pushing the boundaries of brand expression.",
                side: "left",
              ...
              >
                ...
                <div
                  className={`w-full md:w-[45%] pl-16 md:pl-0 ${
                    item.side === "right"
                      ? "md:pl-16 md:pr-0 text-left"
                      : "md:pr-16 md:text-right text-left"
                  }`}
                >
                  {/* Watermark year */}
                  <div
                    className={`absolute pointer-events-none select-none font-display font-black leading-none text-[clamp(5rem,15vw,12rem)] text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.04)] ${
                      item.side === "right"
                        ? "right-auto left-12 md:left-[52%]"
                        : "left-auto right-12 md:right-[52%]"
                  ...
                  <div className="relative z-10">
                    {/* Year pill */}
                    <span
                      className={`inline-block text-xs font-black tracking-[0.25em] uppercase mb-3 text-transparent bg-clip-text bg-gradient-to-r ${item.color}`}
                    >
                      {item.year}
                    </span>

                    {/* Sub-label */}
                    <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-white/30 mb-3">
                      {item.sub}
                    </p>

                    {/* Title */}
                    <h3 className="text-3xl md:text-4xl font-display font-black text-white tracking-tight mb-4 leading-tight">
                      {item.title}
                    </h3>

                    {/* Body */}
                    <p className="text-brand-grey text-base md:text-lg font-light leading-relaxed max-w-md">
                      {item.body}
                    </p>
                  </div>
                </div>
                ...
                <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 top-2 flex-col items-center">
                  <div className={`absolute w-6 h-6 ${item.glow} rounded-full blur-md opacity-60`} />
                  <div className={`w-3 h-3 rounded-full bg-gradient-to-br ${item.color} relative z-10`} />
                  <div className={`absolute w-8 h-8 rounded-full border border-white/10 animate-ping opacity-20`}
                    style={{ animationDuration: `${2 + idx * 0.4}s` }} />
                </div>

                {/* Node — mobile (left rail) */}
                <div className="md:hidden absolute left-6 -translate-x-1/2 top-2 flex flex-col items-center">
                  <div className={`absolute w-5 h-5 ${item.glow} rounded-full blur-md opacity-60`} />
                  <div className={`w-2.5 h-2.5 rounded-full bg-gradient-to-br ${item.color} relative z-10`} />
                </div>
              </motion.div>
            ))}
          </div>
